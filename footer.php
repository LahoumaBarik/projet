            ...
            <div class="col-lg-3 col-sm-6 text-center text-sm-left">
                <div class="row">
                    ...
                    <div class="col-12">
                        <form action="#">
                            <div class="mb-3">
                                <input type="text" class="form-control" placeholder="Entrez votre email..." required>
                            </div>
                            <div class="mb-3">
                                <button class="btn btn-outline-light text-uppercase">S'abonner</button>
                            </div>
                        </form>
                    </div>
                </div>
